...
cleanup() {
  ...
  docker compose -f /workspace/results/vllm_experiment/sample_1/cvdp_copilot_16qam_mapper/harness/6/docker-compose.yml -p cvdp_copilot_16qam_mapper_6_1755638758 kill direct 2>/dev/null || true
  docker rmi cvdp_copilot_16qam_mapper_6_1755638758-direct 2>/dev/null || true
...
echo "Running harness with project name: cvdp_copilot_16qam_mapper_6_1755638758"
